...
router.get('/:id', requirePermisos('REM_VERALL', 'REM_VERREG'), asyncHandler(reemplazoBenProyectoController.obtener));
router.post(
  '/',
...
router.delete('/:id', requireRoles('ADMIN'), asyncHandler(reemplazoBenProyectoController.eliminar));
